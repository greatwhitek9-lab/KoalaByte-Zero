...
- Route MIC1 to J12 / J_MIC with strain relief and, where practical, twisted or shielded conductors.
- Keep MIC1 wiring away from the 5V high-current rail, REG1, battery/BMS wiring, and RF antenna feedlines.
...
- F1 is now 10A-class input protection. Validate fuse/current behavior under full Jetson + display + USB + radio + audio load.
- Keep battery/BMS and high-current wiring away from GPS patch antenna, SDR coax, NFC coil, and MIC1 audio wiring.
...
Optional LTE fourth antenna is DNP unless an LTE variant is built. GPS uses a top/rear active patch antenna. NFC uses an internal left-ear coil. MIC1 is not an antenna; it is the right-ear acoustic input for AI pet voice interaction.
