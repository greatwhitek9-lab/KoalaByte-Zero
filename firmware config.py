...
class UIConfig:
    ...
    # Theme
    PRIMARY_COLOR = DEFAULT_UI_COLORS["PRIMARY"]
    SECONDARY_COLOR = DEFAULT_UI_COLORS["SECONDARY"]
    ACCENT_COLOR = DEFAULT_UI_COLORS["ACCENT"]
    BACKGROUND_COLOR = DEFAULT_UI_COLORS["BACKGROUND"]
    TEXT_COLOR = DEFAULT_UI_COLORS["TEXT"]
